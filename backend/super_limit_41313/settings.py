"""
Django settings for super_limit_41313 project.
...
ROOT_URLCONF = 'super_limit_41313.urls'
...
WSGI_APPLICATION = 'super_limit_41313.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "super_limit_41313 API",
    "DESCRIPTION": "API documentation for super_limit_41313 App",
    "VERSION": "v1",
}
